...
data class MRectangle(
    ...
    companion object {
        val POOL: ConcurrentPool<MRectangle> =
            ConcurrentPool<MRectangle>({ it.clear() }) { MRectangle() }
    ...
    @KormaMutableApi
    fun asInt(): MRectangleInt = MRectangleInt(this)
    @KormaMutableApi
    val int: MRectangleInt get() = MRectangleInt(x, y, width, height)
