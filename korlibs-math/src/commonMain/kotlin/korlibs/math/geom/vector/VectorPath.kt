...
class VectorPath(
    ...
    override fun getBounds(): Rectangle = (BoundsBuilder.Companion() + this).bounds
    ...
    fun scale(sx: Double, sy: Double = sx): VectorPath = transformPoints {
        Point(
            it.x * sx,
            it.y * sy
        )
